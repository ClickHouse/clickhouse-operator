...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionProbeSpec) DeepCopyInto(out *VersionProbeSpec) {
	*out = *in
	if in.Labels != nil {
		in, out := &in.Labels, &out.Labels
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionProbeSpec.
func (in *VersionProbeSpec) DeepCopy() *VersionProbeSpec {
	if in == nil {
		return nil
	}
	out := new(VersionProbeSpec)
