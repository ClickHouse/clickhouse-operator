...
func (in *ClickHouseClusterSpec) DeepCopyInto(out *ClickHouseClusterSpec) {
	*out = *in
	...
	if in.VersionProbe != nil {
		in, out := &in.VersionProbe, &out.VersionProbe
		*out = new(VersionProbeOverride)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionProbeOverride) DeepCopyInto(out *VersionProbeOverride) {
	*out = *in
	if in.PodLabels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionProbeOverride.
func (in *VersionProbeOverride) DeepCopy() *VersionProbeOverride {
	if in == nil {
		return nil
	}
	out := new(VersionProbeOverride)
