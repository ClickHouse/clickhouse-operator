...
CRD_COMPAT_EMBEDDED_TYPE_RE := (securityContext|windowsOptions)\.|metadata\.(labels|annotations) |resources\.(limits|requests) |selector\.matchLabels|nodeSelector|"NoBools".*containers\[\*\]\.
